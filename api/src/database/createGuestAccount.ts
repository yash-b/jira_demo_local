...
const seedProject = (users: User[]): Promise<Project> =>
  createEntity(Project, {
    name: 'CPSC 542 - Software Testing',
    url: 'https://www.github.com/yash-b/jira_demo_local',
    description:
      'Plan, track, and manage your agile and software development projects in a Jira clone. Customize your workflow, collaborate, and release great software.',
...
const seedIssues = (project: Project): Promise<Issue[]> => {
  ...
  const issues = [
    createEntity(Issue, {
      title: 'Hardcode all issues and their attributes.',
      type: IssueType.TASK,
    ...
    createEntity(Issue, {
      title: "Implement comments on issues.",
      type: IssueType.TASK,
      status: IssueStatus.BACKLOG,
    ...
    createEntity(Issue, {
      title: 'Implement different priority scale.',
      type: IssueType.TASK,
    ...
    createEntity(Issue, {
      title:
        'Implement multiple integration tests.',
      type: IssueType.TASK,
    ...
    createEntity(Issue, {
      title: 'Prepare project report and slides.',
      type: IssueType.TASK,
